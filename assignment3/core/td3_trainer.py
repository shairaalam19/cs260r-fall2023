...
class TD3Trainer:
    ...
    def train(self, replay_buffer, batch_size=256):
        ...
        with torch.no_grad():
            ...
            target_Q_tuple = self.critic_target(next_state, next_action)
            # print("type: ", type(target_Q_tuple), "target_Q_tuple", target_Q_tuple)
            # Unpack the tuple
            target_Q1, target_Q2 = target_Q_tuple

            # Compute the critic objective
